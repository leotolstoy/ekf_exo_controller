...
if __name__ == '__main__':
	...
	filename = 'AB06_EKF_TPVB_02.csv'

	AB_SUBJECT = 'AB06'

	# Load in HS data
	nrows_HS = 269 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80739# row num that contains AB0's:
	...
	nrows = 8046 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPVB_02_processed.csv',index=False)
