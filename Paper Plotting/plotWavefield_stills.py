...
data = np.loadtxt("../Wavefield/Run 2/Wavefield/Wave_6.csv", delimiter=',')

#STOMP TIME : 14.97
#START TIME FILE: 19.2
#START TIME VID: 617/60
...
axs[1].set_ylabel(r"$Phase\ Rate\ (s^{-1})$", fontsize=fontSizeAxes, labelpad=0)
...
axs[3].set_ylabel(r"$Incline\ (^{\circ})$", fontsize=fontSizeAxes, labelpad=0)
