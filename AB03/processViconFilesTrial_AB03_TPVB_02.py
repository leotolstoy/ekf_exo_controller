...
if __name__ == '__main__':
	...
	filename = 'AB03_EKF_TPVB_02.csv'

	AB_SUBJECT = 'AB03'

	# Load in HS data
	nrows_HS = 283 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80793# row num that contains AB0's:
	...
	nrows = 8050 #=  num frames, alsolast idx - row with frame subframe
