...
if __name__ == '__main__':
	...
	filename = 'AB03_EKF_TPVC_03.csv'

	AB_SUBJECT = 'AB03'

	# Load in HS data
	nrows_HS = 303 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80893# row num that contains AB0's:
	...
	nrows = 8058 #=  num frames, alsolast idx - row with frame subframe
