...
if __name__ == '__main__':
	...
	filename = 'AB03_EKF_TPVA_01.csv'

	AB_SUBJECT = 'AB03'

	# Load in HS data
	nrows_HS = 281 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80861# row num that contains AB0's:
	...
	nrows = 8057 #=  num frames, alsolast idx - row with frame subframe
