...
if __name__ == '__main__':
	...
	filename = 'AB01 EKF Forward Test Protocol V2, Exp 02.csv'

	AB_SUBJECT = 'AB01'
	# Load in forceplate data

	n_skiprows_forceplate_1 = 929# row num that contains RightForcePlates:
	...
	nrows = 30001*10 #=  row index containing the final forceplate data row
	...
	# Load in HS data
	nrows_HS = 925 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 300945# row num that contains AB0's:
	...
	nrows = 30001 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}ForwardTest02_processed.csv',index=False)
