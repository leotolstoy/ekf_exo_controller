...
if __name__ == '__main__':
	...
	filename = 'AB01 FootMarkers EKFTPV4B 06.csv'
	...
	nrows = 7993*10 #=  row index containing the final forceplate data row
	...
	# MARKER
	n_skiprows_marker_1 = 80203# row num that contains AB0's:
	...
	nrows = 7993 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPV4B_06_processed.csv',index=False)
