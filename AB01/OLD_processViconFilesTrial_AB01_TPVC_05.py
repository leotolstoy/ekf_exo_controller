...
if __name__ == '__main__':
	...
	filename = 'AB01 FootMarkers EKFTPV4C 05.csv'

	AB_SUBJECT = 'AB01'
	# Load in forceplate data

	n_skiprows_forceplate_1 = 275# row num that contains RightForcePlates:
	...
	nrows = 8022*10 #=  row index containing the final forceplate data row
	...
	# Load in HS data
	nrows_HS = 271 #row number of the last HS row
	...
	# MARKER
	n_skiprows_marker_1 = 80501# row num that contains AB0's:
	...
	nrows = 8022 #=  num frames, alsolast idx - row with frame subframe
	...
	df.to_csv(f'Vicon_{AB_SUBJECT}TPV4C_05_processed.csv',index=False)
