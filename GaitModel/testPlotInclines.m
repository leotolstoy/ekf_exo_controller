...
%             plot_j.Color(4) = 0.2;
            ...
            figure(2)
            plot_j = plot3(percent_gait,treadmillIncline*ones(size(percent_gait)), foot_angle_data_col, c1{j},'LineWidth',2);
            plot_j.Color(4) = c2(j);
...
%             plot_j.Color(4) = 0.2;
            ...
            figure(4)
            plot_j = plot3(percent_gait,treadmillIncline*ones(size(percent_gait)), shank_angle_data_col, c1{j},'LineWidth',2);
            plot_j.Color(4) = c2(j);
